...
if exist WORKING/system/bin/.ext/.su echo set_perm(0, 0, 06755, "/system/bin/.ext/.su"); >> WORKING/META-INF/com/google/android/updater-script
...
if not exist WORKING/system/bin/.ext/.su echo ##ROOTLINE##set_perm(0, 0, 06755, "/system/bin/.ext/.su"); >> WORKING/META-INF/com/google/android/updater-script
